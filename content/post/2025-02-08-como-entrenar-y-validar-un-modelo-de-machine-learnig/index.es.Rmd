...
Contar con una estrategia de modelado correcta es esencial para desarrollar y validar modelos de predicción. En este artículo, exploraremos las etapas clave del proceso de modelado propuesto por Ewout Steyerberg. Además usaremos como ejemplo la base de datos de la tesis de doctorado titulada "MODELOS PREDICTIVOS PARA LA ESTIMACIÓN Y CLASIFICACIÓN DEL RIESGO DE MUERTE EN COVID-19"
